...
public class ChangeEventEntryTable extends TableImpl<QChangeEventEntryRecord> {
    ...
    public UniqueKey<QChangeEventEntryRecord> getPrimaryKey() {
        return Internal.createUniqueKey(ChangeEventEntryTable.CHANGE_EVENT_ENTRY, DSL.name("change_event_entry_pkey"), new TableField[] { ChangeEventEntryTable.CHANGE_EVENT_ENTRY.CHANGE_EVENT_ENTRY_ID }, true);
    }

    @Override
    public List<UniqueKey<QChangeEventEntryRecord>> getKeys() {
        return Arrays.<UniqueKey<QChangeEventEntryRecord>>asList(
              Internal.createUniqueKey(ChangeEventEntryTable.CHANGE_EVENT_ENTRY, DSL.name("change_event_entry_pkey"), new TableField[] { ChangeEventEntryTable.CHANGE_EVENT_ENTRY.CHANGE_EVENT_ENTRY_ID }, true)
        );
    }
