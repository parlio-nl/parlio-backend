...
public class PersonTable extends TableImpl<QPersonRecord> {
    ...
    public <O extends Record> PersonTable(Table<O> child, ForeignKey<O, QPersonRecord> key) {
    ...
    public List<UniqueKey<QPersonRecord>> getKeys() {
        return Arrays.<UniqueKey<QPersonRecord>>asList(Keys.PERSON_PKEY, Keys.PERSON_SLUG_KEY);
    }
