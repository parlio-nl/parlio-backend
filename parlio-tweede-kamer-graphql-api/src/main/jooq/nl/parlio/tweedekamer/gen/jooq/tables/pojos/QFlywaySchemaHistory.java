...
public class QFlywaySchemaHistory implements Serializable {
    ...
    public QFlywaySchemaHistory(QFlywaySchemaHistory value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("QFlywaySchemaHistory (");
